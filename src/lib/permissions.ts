...
export const rolePermissions: Record<RoleName, Permission[]> = {
  ...
  salesManager: ["leads.create", "leads.readAll", "leads.updateAssigned", "leads.assign", "clients.create", "clients.read", "clients.update", "deals.create", "deals.read", "deals.update", "installations.create", "installations.read", "properties.read", "units.read", "marketing.read", "offerings.read", "inventory.read", "inventory.viewReports", "inventory.reserve", "pos.read", "pos.sell", "tasks.create", "tasks.read", "activities.create", "activities.read"],
  salesExecutive: ["leads.create", "leads.readAssigned", "leads.updateAssigned", "clients.create", "clients.read", "deals.create", "deals.read", "deals.update", "installations.create", "installations.read", "properties.read", "units.read", "offerings.read", "inventory.read", "inventory.reserve", "pos.read", "pos.sell", "tasks.create", "tasks.read", "activities.create", "activities.read"],
  ...
  financeManager: ["clients.read", "properties.read", "units.read", "deals.read", "installations.read", "rentals.read", "rentals.update", "offerings.read", "inventory.read", "inventory.viewReports", "inventory.comment", "inventory.approve", "pos.read", "activities.create", "activities.read", "finance.create", "finance.update", "finance.approve", "reports.viewFinancial", "auditLogs.read"],
  accountant: ["clients.read", "properties.read", "deals.read", "installations.read", "rentals.read", "rentals.update", "offerings.read", "inventory.read", "inventory.viewReports", "pos.read", "activities.create", "activities.read", "finance.create", "finance.update", "reports.viewFinancial"],
  legalOfficer: ["clients.read", "properties.read", "deals.read", "rentals.read", "offerings.read", "auditLogs.read"],
  projectManager: ["properties.read", "properties.update", "development.create", "development.read", "development.update", "installations.create", "installations.read", "installations.update", "offerings.read", "inventory.read", "inventory.issue", "inventory.reserve", "inventory.procure", "tasks.create", "tasks.read", "tasks.update", "activities.create", "activities.read"],
  ...
  auditor: ["dashboard.viewExecutive", "leads.readAll", "clients.read", "deals.read", "installations.read", "properties.read", "units.read", "rentals.read", "development.read", "marketing.read", "offerings.read", "inventory.read", "inventory.viewReports", "pos.read", "tasks.read", "activities.read", "reports.viewFinancial", "auditLogs.read"],
