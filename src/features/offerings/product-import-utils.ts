...
const headerAliases: Record<string, string[]> = {
  ...
  wholesalePrice: ["wholesaleprice", "tradeprice", "bulkprice", "dealerprice"],
...
export function previewProductImport(
  ...
  return rows.map<ProductImportPreviewRow>((row, index) => {
    ...
    const payload = {
      ...
      wholesalePrice: optionalNumber(mappedValue(row, "wholesalePrice", mapping), "Wholesale price", errors),
