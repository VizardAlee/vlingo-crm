...
export const guideTopics: GuideTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "On the Inventory tab, review tracked and out-of-stock products, current on-hand/reserved/available quantities, cost-based stock value, units and value by brand, movements by type, detailed item status, location totals, and the selected-period movement ledger.",
