...
- Point of Sale: branch-aware checkout, directly typed whole-number quantities with plus/minus shortcuts, customer details, discounts, tax, full/partial/unpaid sales, stock deduction, sales history, later payments, and selectable Vlingo Systems or Kada Builders Mart printable invoices and receipts.
...
- Point of Sale sells from the active branch's available balance. A user can type a full whole-number cart quantity or use plus/minus shortcuts and choose Vlingo Systems or Kada Builders Mart for the sale documents. Checkout creates the sale, branch-coded VSL or KBM invoice number, optional numbered receipt and finance payment, inventory issues, and stock deductions atomically. It supports walk-in customers, discounts, tax, unpaid invoices, part payments, and a separate consistently branded receipt for every later payment.
