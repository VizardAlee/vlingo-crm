...
- On phones and tablets, Point of Sale uses three focused steps: Products, Customer, and Pay. Product cards show available stock, prices, and the quantity already in the cart; large quantity controls, full-width navigation, and a sticky total button make checkout easier without changing the desktop workflow.
