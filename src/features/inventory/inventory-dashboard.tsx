...
export function InventoryDashboard() {
  ...
  const inventoryTourSteps = useMemo<GuidedTourStep[]>(() => {
    const steps: GuidedTourStep[] = [
      { target: "inventory-heading", title: isPartner ? "Your brand inventory" : "Inventory workspace", body: isPartner ? "This read-only dashboard shows your assigned brands across every branch." : "Use this workspace to monitor stock and carry out the inventory actions allowed by your role and branch." },
