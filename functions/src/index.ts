...
const rolePermissions = {
  ...
  managingDirector: ["dashboard.viewExecutive", "leads.readAll", "clients.read", "properties.read", "units.read", "rentals.read", "tasks.read", "activities.read", "reports.viewFinancial", "auditLogs.read"],
  operationsManager: ["dashboard.viewExecutive", "leads.create", "leads.readAll", "leads.assign", "clients.create", "clients.read", "clients.update", "properties.create", "properties.read", "properties.update", "units.create", "units.read", "units.update", "rentals.create", "rentals.read", "rentals.update", "tasks.create", "tasks.read", "tasks.update", "activities.create", "activities.read", "users.manage"],
  ...
  propertyManager: ["properties.create", "properties.read", "properties.update", "units.create", "units.read", "units.update", "rentals.create", "rentals.read", "rentals.update", "tasks.create", "tasks.read", "activities.create", "activities.read"],
  ...
  auditor: ["dashboard.viewExecutive", "leads.readAll", "clients.read", "properties.read", "units.read", "rentals.read", "tasks.read", "activities.read", "auditLogs.read"],
} as const;
